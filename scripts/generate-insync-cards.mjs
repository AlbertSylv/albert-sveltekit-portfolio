...
const SOURCE = {
	general: [
		...
		['practical-ridiculous', 'Practical', 'Ridiculous', 'Praktisk', 'Ridiculous'],
	...
	social: [
		...
		['acceptable-lie-unforgivable-lie', 'Acceptable lie', 'Unforgivable lie', 'Acceptabel løgn', 'Uforgivelig løgn'],
	...
	food: [
		...
		['mess-free-extremely-messy', 'Mess-free', 'Extremely messy', 'Rent på fingrene', 'Ekstremt svineri'],
		['worth-mess-not-worth-mess', 'Worth the mess', 'Not worth the mess', 'Messen er det værd', 'Messen er ikke det værd'],
		['bland-intense', 'Bland', 'Intense', 'Smagsløs', 'Intens'],
		['dry-saucy', 'Dry', 'Saucy', 'Tør', 'Sovsfuld'],
		['light-meal-food-coma', 'Light meal', 'Food coma', 'Let måltid', 'Madmætte'],
		...
		['mild-painfully-spicy', 'Mild', 'Painfully spicy', 'Mild', 'Smertefuld stærk'],
	...
	pop: [
		...
		['low-budget-blockbuster', 'Low-budget energy', 'Blockbuster energy', 'Lavt budget-holdning', 'Blockbuster-holdning'],
	...
	life: [
		...
		['fake-job-real-job', 'Fake-sounding job', 'Real-sounding job', 'Lyder som løgn-job', 'Lyder som rigtigt job'],
		...
		['low-pressure-high-pressure-decision', 'Low-pressure decision', 'High-pressure decision', 'Lavt pres-beslutning', 'Højt pres-beslutning'],
	...
	places: [
		...
		['good-nap-terrible-nap', 'Good place to nap', 'Terrible place to nap', 'Godt sted at nap', 'Forfærdeligt sted at nap'],
	...
	weird: [
		...
		['goblin-royalty', 'Goblin energy', 'Royalty energy', 'Nisse-energi', 'Konge-energi'],
		...
		['tiny-animal-large-animal', 'Tiny animal energy', 'Large animal energy', 'Lille dyr-energi', 'Stort dyr-energi'],
		['scared-of-goose-goose-scared', 'Would be scared of a goose', 'A goose would be scared of them', 'Bliver bange for en gås', 'En gås blev bange for dem'],
	...
	debate: [
		...
		['classy-trashy', 'Classy', 'Trashy', 'Stilfuld', 'Trashy'],
		...
		['real-holiday-fake-holiday', 'Real holiday', 'Fake holiday', 'Rigtig helligdag', 'Fake helligdag'],
		...
		['harmless-prank-cruel-prank', 'Harmless prank', 'Cruel prank', 'Harmløs practical joke', 'Grusom practical joke'],
